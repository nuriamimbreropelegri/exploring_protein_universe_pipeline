...
2. Create a file containing the nodes of a subset of the alignment file (the first 1M alignments). [3. Network (b: nodes in the subset network)]
3. Create a network representation of a subset of conserved fragments containing 1 million alingment hits
