...
1. Create a database containing 2 columns where in the first appears the tags of the ESM atlas sequences that found a hit in SCOPe and in the second one the corresponding fold or domain: [Database with the tags of the annotated ESM atlas sequences and its corresponding fold](2. Annotation (b: assigning a fold to ESM atlas sequences))
